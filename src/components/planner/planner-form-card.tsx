import { GroceryItemPriority } from "@/lib/server/db/schemas";
import { GroceryCategory, useGroceryStore } from "@/stores/grocery-store";
...
const priorities: GroceryItemPriority[] = ["low", "medium", "high"];
...
const PlannerFormCard = () => {
  ...
  const [priority, setPriority] = useState<GroceryItemPriority>("medium");
  ...
  return (
    <View className="rounded-3xl border border-border bg-card p-4">
      {/* NAME */}
      <Text className="text-sm font-semibold text-foreground">商品名称</Text>
